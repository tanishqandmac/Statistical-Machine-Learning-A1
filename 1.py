...
def main():
    ...
    for POS in range(0,10):
        ...
        xaxis.append(FPRList)
        yaxis.append(TPRList)
        
    line_colors = ['r', 'g', 'b', 'c', 'm', 'y', 'k', 'r', 'g','b']
    #plt.gca().set_color_cycle(['red', 'green', 'blue', 'yellow', 'pink', 'black', 'brown', 'violet'])
    for i in range(0,len(xaxis)):
        plt.plot(xaxis[i],yaxis[i],lw=lw,c = line_colors[i])
